...
class FineGrained3GNN(nn.Module):
    ...
    def forward(self, x, y):
        ...
        with torch.enable_grad():
            grad_cam = GradCam(model=self, feature_extractor=self.gc_expert_3, fc=self.fc_expert_3, rate=self.rate_3)
            mask_3, nodes_cam_3 = grad_cam(input_box_2.detach(), y)
        ...
        return logits_gate, nodes_cam_1, nodes_cam_2, nodes_cam_3, mask_1, mask_2, mask_3
