...
if __name__ == '__main__':
    ...
    if my_args.dataset_name == 'MPED':
        bad = [2, 3, 7, 12, 13, 14, 25, 26, 30]
        middle = [9, 10, 11, 15, 16, 19, 21, 27, 29]
        good = [1, 4, 5, 6, 8, 17, 18, 20, 22, 23, 24, 28]

    elif my_args.dataset_name == 'SEED':
        bad = [3, 6, 8, 11, 12, 13, 14, 15, 17, 18, 21, 28, 29, 31, 34, 35, 37, 42]
        middle = [5, 26, 30, 38, 39, 40]
        good = [1, 2, 4, 7, 9, 10, 16, 19, 20, 22, 23, 24, 25, 27, 32, 33, 36, 41, 43, 44, 45]

    elif my_args.dataset_name == 'SEED_IV':
        bad = [11, 13, 21, 30, 35, 42]
        middle = [1, 6, 17, 18, 26, 28, 33, 36, 39, 43]
        good = [2, 3, 4, 5, 7, 8, 9, 10, 12, 14, 15, 16, 19, 20, 22, 23, 24, 25, 27, 29, 31, 32, 34, 37, 38, 40, 41, 44, 45]
