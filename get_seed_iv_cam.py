...
class Node_heater(object):
    ...
    def __init__(self, args, people_index):
        ...
        try:
            ...
            self.args.filter_num = 64
            self.model = FineGrained3GNN(self.args, adj=self.adj_matrix).to(DEVICE)
            self.model.load_state_dict(torch.load(self.state_dict_path, map_location=torch.device('cpu')))
            self.args.filter_num = 32
                ...
                for pd_y, gt_y, my_cam_1, my_cam_2, my_cam_3, mask_1, mask_2, mask_3 in zip(pred_y, labels, cam_1, cam_2, cam_3, indices_1, indices_2, indices_3):
                    if pd_y == gt_y:
                        ...
                        if pd_y == 1:   # funny
                            ...
                            node_heats_fear_1 += my_cam_1
                            node_heats_fear_2 += my_cam_2
                            node_heats_fear_3 += my_cam_3
        return node_heats_1, node_heats_positive_1, node_heats_neal_1, node_heats_negative_1, node_heats_fear_1, \
               node_heats_2, node_heats_positive_2, node_heats_neal_2, node_heats_negative_2, node_heats_fear_2, \
               node_heats_3, node_heats_positive_3, node_heats_neal_3, node_heats_negative_3, node_heats_fear_3
...
if __name__ == '__main__':
    ...
    final_cam_fear_1 = np.zeros((1, 62))
    ...
    final_cam_fear_2 = np.zeros((1, 62))
    ...
    final_cam_fear_3 = np.zeros((1, 62))
    ...
    for i in sorted(people_list):
        ...
        cam_map_1, cam_map_positive_1, cam_map_neal_1, cam_map_negative_1, cam_map_fear_1, \
        cam_map_2, cam_map_positive_2, cam_map_neal_2, cam_map_negative_2, cam_map_fear_2, \
        cam_map_3, cam_map_positive_3, cam_map_neal_3, cam_map_negative_3, cam_map_fear_3 = heater.test_3_experts()
        ...
        final_cam_fear_1 += cam_map_fear_1
        ...
        final_cam_fear_2 += cam_map_fear_2
        ...
        final_cam_fear_3 += cam_map_fear_3
    ...
    final_cam_fear_1 = str(get_map(final_cam_fear_1)).replace('\n', '\t').strip()
    ...
    final_cam_fear_2 = str(get_map(final_cam_fear_2)).replace('\n', '\t').strip()
    ...
    final_cam_fear_3 = str(get_map(final_cam_fear_3)).replace('\n', '\t').strip()
